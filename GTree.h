...
int get(int) - Returns the value at an address.
...
void set(int, int) - Sets the value at the address of the first int to be the value of the second int. This should only be needed for the first value, which isn't a child of anything.
